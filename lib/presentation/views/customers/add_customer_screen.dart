...
class _AddCustomerScreenState extends State<AddCustomerScreen> {
  ...
  Future<void> _saveCustomer() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      developer.log('Starting save customer process...', name: 'AddCustomerScreen');
      ...
      try {
        ...
        developer.log('Save operation finished. Success: $success', name: 'AddCustomerScreen');
        ...
        developer.log('Exception in _saveCustomer: $e', name: 'AddCustomerScreen', error: e);
        if (mounted) {
          setState(() => _isSaving = false);
          ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // استخدمنا IgnorePointer لتعطيل التفاعل مع النموذج بالكامل أثناء الحفظ
      // بدلاً من تمرير enabled لكل حقل
      body: IgnorePointer(
        ignoring: _isSaving,
        child: Form(
          key: _formKey,
          child: ListView(
            ...
            children: [
              CustomTextField(
                ...
                // تم إزالة enabled: !_isSaving لأنه غير معرف
              ),
              ...
              if (isEditing) ...[
                ...
                DropdownButtonFormField<CustomerStatus>(
                  // تصحيح: استخدام initialValue بدلاً من value لتفادي الخطأ
                  // واستخدام key لإجبار إعادة البناء إذا تغيرت الحالة (اختياري هنا لأن الصفحة تُبنى مرة واحدة للتعديل)
              ...
              CustomButton(
                text: isEditing 
                    ? AppLocalizations.of(context)!.updateCustomerLabel 
                    : AppLocalizations.of(context)!.addCustomerLabel,
